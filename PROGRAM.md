...
Improve the geometric mean ops/sec across the standard benchmark suite (strings, objects, arrays, nested arrays, nested arrays with objects, mixed, and mixed with bad data) while maintaining correctness and passing all tests.

## What you CAN modify

- `src/index.js` — main clsx implementation
- `src/lite.js` — lite version (string-only)
...
- `bench/eval.js` — evaluation harness
- `test/` — test suite
- `bin/` — build system
